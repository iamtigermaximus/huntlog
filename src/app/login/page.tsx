...
const OAuthErrors: Record<string, string> = {
  ...
  OAuthAccountNotLinked: "This Google account is not linked. Sign in with your credentials instead.",
...
function LoginForm() {
  ...
  const errorMessage = oauthError ? (OAuthErrors[oauthError] || OAuthErrors.default) : null;
  ...
  return (
    <Container>
      <LoginCard>
        ...
        <GoogleButton onClick={handleGoogleSignIn} disabled={googleLoading}>
          {googleLoading ? (
